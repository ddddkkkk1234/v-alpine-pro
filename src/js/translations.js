window.translations = {
    en: {
        ...
        premiumTitleLoginRequired: 'Login required',
        premiumTitleAccessRequired: 'Premium access required',
        premiumCopyLoginRequired: feature => `${feature} is available after login and Premium access check.`,
        premiumCopyAccessRequired: feature => `${feature} is a Premium-only feature. You are logged in, but your account does not have Premium access. Please contact support below to activate.`,
        logout: 'Log out',
    ...
    ko: {
        ...
        premiumTitleLoginRequired: '로그인이 필요합니다',
        premiumTitleAccessRequired: 'Premium 권한이 필요합니다',
        premiumCopyLoginRequired: feature => `${feature} 기능은 로그인 후 Premium 권한이 확인되면 이용할 수 있습니다.`,
        premiumCopyAccessRequired: feature => `${feature} 기능은 Premium 전용 기능입니다. 로그인 완료되었으나 Premium 권한이 활성화되지 않은 계정입니다. 아래 'Premium 문의'를 통해 권한을 활성화해 주세요.`,
        logout: '로그아웃',
    ...
    ja: {
        ...
        premiumCopy: feature => `${feature} 기능은 로그인 후 Premium 권한이 확인되면 이용할 수 있습니다.`,
        premiumTitleLoginRequired: 'ログインが必要です',
        premiumTitleAccessRequired: 'Premium権限が必要です',
        premiumCopyLoginRequired: feature => `${feature}機能はログイン後、Premium権限が確認されればご利用いただけます。`,
        premiumCopyAccessRequired: feature => `${feature}機能はPremium専用機能です。ログインしましたが、Premium権限が有効化されていないアカウントです。下記の「Premium問い合わせ」から権限を有効にしてください。`,
        logout: 'ログアウト',
